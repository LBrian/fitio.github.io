...
//    "use strict";
//
//    var svg = document.querySelector( '.genesisPreloader' );
//
...
var LoadPrecente = function () {
    ...
    LoadPrecent.prototype = {
        ...
        start      : function ( ) {
            ...
            var genesisPreloader = wrapp.querySelector('.genesisPreloader');
            ...
            function startShow () {
                ...
                if ( $(wrapp).hasClass('show-preloader') ) {
                    ...
                    $(genesisPreloader).addClass('stop');
                ...
                setTimeout(function(){
                    genesisPreloader.parentNode.removeChild(genesisPreloader);
